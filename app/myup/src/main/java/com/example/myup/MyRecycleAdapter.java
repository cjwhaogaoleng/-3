...
public class MyRecycleAdapter extends RecyclerView.Adapter<MyRecycleAdapter.myViewHolder> {
    ...
    @NonNull
    @Override
    public MyRecycleAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.updata_item_headandname, null);
        return new myViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MyRecycleAdapter.myViewHolder holder, int position) {
